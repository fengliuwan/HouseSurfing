...
class UploadStay extends React.Component {
    ...
    handleSubmit = async (values) => {
        ...
        // need to have .current when reading file ref
        // created to get ref for files uploaded
        ...
        return (
            ...
            >
                ...
                <Form.Item name="picture" label="Picture" rules={[{ required: true }]}>
                    <input              // html element, not antd component
                        type="file"     // type has to be file here, js can only access file reference not content
