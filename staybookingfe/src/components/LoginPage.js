...
class LoginPage extends React.Component {
    formRef = React.createRef();    // give object to form so that formRef can be updated by Form
    state = {
        asHost: false,
        Loading: false,
    }
    ...
    handleLogin = async () => {
        const formInstance = this.formRef.current;  // form saves all info under field current
