...
import { message, Tabs, Typography, List, Form, InputNumber, DatePicker,
        Button, Card, Carousel, Image, Modal} from "antd";
import { LeftCircleFilled, RightCircleFilled } from "@ant-design/icons";
import { bookStay, getReservations, searchStays, cancelReservation } from '../utils';
import { StayDetailInfoButton } from "./HostHomePage";

const { TabPane } = Tabs; // deconstruct TabPane from Tabs
