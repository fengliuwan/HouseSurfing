...
public class Stay implements Serializable {
    ...
    @ManyToOne
    @JoinColumn(name = "user_id") // User will be saved under col "user_id"
    private User host;

    // table mapped by stay table (many side), do not create extra table
    // used foreign key to associate two tables, no new table created
    // if stay deleted, delete associated stayimage too
