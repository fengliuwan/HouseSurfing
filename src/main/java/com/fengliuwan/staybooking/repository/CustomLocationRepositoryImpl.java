...
// spring can detect the class and create object without annotation
public class CustomLocationRepositoryImpl implements CustomLocationRepository {
    ...
    // implementation of searchByDistance so that spring can inject into LocationRepository
    @Override
    public List<Long> searchByDistance(double lat, double lon, String distance) {
        ...
        queryBuilder
                .withFilter(new GeoDistanceQueryBuilder("geoPoint")
                .point(lat, lon)
