package com.fengliuwan.staybooking.filter;
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest,
        ...
        if (jwt != null && jwtUtil.validateToken(jwt) && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (authority != null) {
                ...
                // 把token存在系统分配给用户的线程中
                // save token in Security context holder， this token is different from token generated and returned to user
                // compared with session, we do not need to maintain session object. even though both saved in thread memory
